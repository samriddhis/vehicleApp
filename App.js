...
class App extends React.Component {
  ...
  shouldComponentUpdate(props, state) {
    ...
    if (props.sort !== this.props.sort) {
      this.applySortOption(props.sort);
    }
    return true;
  }
